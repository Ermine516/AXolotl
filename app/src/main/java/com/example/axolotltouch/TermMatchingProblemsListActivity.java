    ...
    protected void ActivityDecorate() {
        ...
        try {
            ...
            for (String problem : problems) {
                ...
                ProblemState newPS = AuxFunctionality.loadFile(manager.open("termMatchingProblems/" + problem), problem, this);
                ...
                TPLL.addView(scrollTextSelectConstruct(problemString.toString(), new ProblemSelectionListener(problems, parsedProblems, "termMatchingProblems/"), this, false));
            }
        } catch (IOException e) {
            Toast.makeText(TermMatchingProblemsListActivity.this, "Issues accessing Problem Database.", Toast.LENGTH_SHORT).show();
            TPLL.removeAllViewsInLayout();
